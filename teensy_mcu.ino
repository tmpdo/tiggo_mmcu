...
#define accPin 12
#define ledPin 11
#define relayPin 1 //output to power button
...
void writeI2c_vol(byte address, byte subaddress0, byte subaddress1, byte value) {
  ...
  Wire.beginTransmission(address); 
  Wire.send(subaddress0);
  Wire.send(subaddress1);
  Wire.send(value);
  Wire.endTransmission();
}
...
Uart.println(frequencyB, HEX);
frequencyH = frequencyB >> 8;
Uart.println(frequencyH, HEX);
frequencyL = frequencyB & 0XFF;
Uart.println(frequencyL, HEX);
